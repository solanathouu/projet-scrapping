...
# Catégorie: Téléphones / Smartphones
# NOTE: Renseignez la valeur exacte de 'valueId' pour la sous-catégorie téléphone du groupe "Categories"
CATEGORY_ID = "FCS"
CATEGORY_VALUE_ID = "FCS_SUBCLASS_TELMOB_TELMOBILE"
PAGE_SIZE = 100
SORT_TYPE = "STOCK"
OUTPUT_CSV = "produits_telephone.csv"
